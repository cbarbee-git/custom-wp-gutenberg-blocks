...
function Edit(_ref) {
  ...
  const onCategoryChange = values => {
    ...
    const updatedCats = values.map(key => {
      return typeof key === 'string' ? catSuggestions[key] : key;
    });
    setAttributes({
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"custom/latest-posts","version":"0.1.0","title":"Custom Latest Posts","category":"widgets","description":"A Custom Block to display and filter latest posts","supports":{"html":false},"textdomain":"boilerplate","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","attributes":{"numberOfPosts":{"type":"number","default":5},"displayFeaturedImage":{"type":"boolean","default":true},"order":{"type":"string","default":"desc"},"orderBy":{"type":"string","default":"date"},"categories":{"type":"array","items":{"type":"object"}}}}');
